...
var BcryptHashing = /** @class */ (function () {
     ...
     * @param value
     */
    BcryptHashing.prototype.createHash = function (value) {
     ...
     * @param hashedValue
     */
    BcryptHashing.prototype.compare = function (value, hashedValue) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, bcrypt_1.default.compare(value, hashedValue)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
